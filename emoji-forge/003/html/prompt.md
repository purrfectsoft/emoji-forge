# Gemini Generation Prompt — Purrfect Universe Emoji #003 (:html:)

Design a flat, vector emoji representing **HTML**, foundation of the web and
skeleton of creativity.

## Visual Intent

- Dominant color: **#E34F26** (HTML orange-red)
...
**Output:** 1024×1024 PNG, flat, centered, solid `#00FF43` background.
